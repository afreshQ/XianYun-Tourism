                ...
                <el-col :span="12">
                    <el-row type="flex" justify="space-between" class="flight-info-center">
                        <el-col :span="8" class="flight-airport">
                            ...
                            <span>{{data.org_airport_name}}{{data.org_airport_quary}}</span>
                        </el-col>
                        ...
                        <el-col :span="8" class="flight-airport">
                            ...
                            <span>{{data.dst_airport_name}}{{data.org_airport_quary}}</span>
                        </el-col>
                    </el-row>
                </el-col>
...
export default {
    ...
    computed:{
        timeRequired(){
            ...
            //全部转换成分钟
            let start=dep[0] * 60+ +dep[1];
            let end=arr[0] * 60+ +arr[1];
            ...
            // 分钟
            let min=(interval % 60)<10?'0'+interval % 60:interval % 60;
